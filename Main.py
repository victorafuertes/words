...
st.write('')
st.write('I definitely could have done a better job with the load times for Page 6 and Page 7, but honestly I feel like I got everything else working as intended. I think the main area(s) that I could improve upon, specifically in the context of this project, would be: the amount of features, observations, and sources (which I will touch upon later on in the questions page).')
st.write('')
